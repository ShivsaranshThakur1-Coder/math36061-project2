function animate_constant_case()
%ANIMATE_CONSTANT_CASE Create an animation for the constant-speed case.

addpath('src');
cfg = fox_rabbit_config();
res = simulate_constant_case();
...
v = VideoWriter('docs/constant_case_animation.mp4','MPEG-4');
v.FrameRate = 30;
open(v);
...
for k = idx
    ...
    title(sprintf('Constant-speed chase, t = %.2f s', t(k)));
